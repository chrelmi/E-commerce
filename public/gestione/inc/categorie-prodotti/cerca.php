...
<div class="btn-group mb-3">
	...
	<a class="btn btn-sm btn-outline-success" href="<?= GESTIONE ?>gestione-categorie-prodotti.php?<?= http_build_query([
	    'nuovo' => true
	]) ?>">
...
<div id="box-ricerca" class="box-ricerca <?= isset($_GET['ricerca']) ? '' : 'd-none' ?>">
    <form action="<?= GESTIONE ?>ricerca/gestione-categorie-prodotti/ricerca.php" method="POST" id="ricerca-categorie-prodotti">
...
<table id="tabella-utenti" class="w-100 datatable-search table" data-idform="ricerca-categorie-prodotti">
	<thead>
		<tr>
		<?php
